...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseDatabase = FirebaseDatabase.getInstance();//TODO FIXME need to add line of code here last 17 min of class
        ...
        if (ref != null) {
            ...
            mDatabaseReference = mFirebaseDatabase.getReference("to_do");// by default is name the object this
